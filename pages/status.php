...
if(isset($_REQUEST['conLinkName']))
	...
	echo "<div class='aa' style='height:460px; overflow:scroll'>";
			...
			{	
				...
				echo "&nbsp;&nbsp;&nbsp;".$c_no;
					echo "</div>";
					echo "<div class='bb2'>";
					echo "<a href='stud.php?c_number=$c_no&amp;startMessage=1&amp;reply=0&amp;forw=0'>";
				if(strlen($sub)<=60)
				{
					echo $sub;
				...
				$i++;
					...
					echo "<div class='bb1'>";
					echo "&nbsp;&nbsp;&nbsp;";
					echo "<a href='stud.php?c_number=$c_no&amp;startMessage=0&amp;reply=1&amp;forw=0'>";
						echo "see response";
					echo "</a>";
					echo "</div>";
					echo "<div class='bb5'>";
		 ...
		 mysql_query($sql1) or die(mysql_error());
					...
					if($days>10)
					{
						if($status=="Not Solved" && $level=="Care Taker")
						{
							echo "<a href='stud.php?c_number=$c_no&amp;startMessage=0&amp;reply=0&amp;forw=1'>";
								echo "forward";
							echo "</a>";
						}
						else if($status=="Not Solved" && $level=="Associate Warden" && $days>15)
						{
							echo "<a href='stud.php?c_number=$c_no&amp;startMessage=0&amp;reply=0&amp;forw=1'>";
								echo "forward";
							echo "</a>";
