	...
	echo "<div class='aa' style='height:450px; overflow:scroll'>";
			...
			{	
				...
				echo "&nbsp;&nbsp;&nbsp;".$c_no;
					echo "</div>";
					echo "<div class='bb2'>";
					echo "<a href='care_taker.php?c_number=$c_no&amp;startMessage=1&amp;reply=0&amp;forw=0'>";
				if(strlen($sub)<=60)
				{
					echo $sub;
				...
				$i++;
					...
					echo "<div class='bb1'>";
					echo "&nbsp;&nbsp;&nbsp;";
					echo "<a href='care_taker.php?c_number=$c_no&amp;startMessage=0&amp;reply=2&amp;forw=0'>";
						echo "give response";
					echo "</a>";
					echo "</div>";
					echo "<div class='bb3'>";
					...
					{
						echo "<a href='care_taker.php?c_number=$c_no&amp;startMessage=0&amp;reply=0&amp;forw=1'>";
							echo "forward";
						echo "</a>";
					}
					echo "</div>";
